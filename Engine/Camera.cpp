...
{
	_position = XMFLOAT3(0, 0, -10);	//カメラの位置
	_target = XMFLOAT3( 0, 0, 0);	//カメラの焦点

	//プロジェクション行列
	float viewWidth = 1280.0f;  // ビューの幅
	float viewHeight = 720.0f; // ビューの高さ
	//_proj = XMMatrixOrthographicLH(viewWidth, viewHeight, 0.1f, 1000.0f);
